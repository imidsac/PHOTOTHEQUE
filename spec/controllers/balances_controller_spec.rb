  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved balance as @balance" do
        post :create, {:balance => invalid_attributes}, valid_session
        expect(assigns(:balance)).to be_a_new(Balance)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested balance" do
        balance = Balance.create! valid_attributes
        put :update, {:id => balance.to_param, :balance => new_attributes}, valid_session
        balance.reload
    ...
    describe "with invalid params" do
      it "assigns the balance as @balance" do
        balance = Balance.create! valid_attributes
        put :update, {:id => balance.to_param, :balance => invalid_attributes}, valid_session
        expect(assigns(:balance)).to eq(balance)
      end
